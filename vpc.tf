...
# FIX: converted from count to for_each - stable keys, avoids index shift on subnet removal
...
resource "aws_cloudwatch_log_group" "flow_log" { #trivy:ignore:AVD-AWS-0017
